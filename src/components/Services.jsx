      ...
      <div className="container">
        ...
        <div className="relative">
            <div className="relative z-1 flex items-center h-[39rem] mb-5 p-8 border border-n-1/10 rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem]">
               <div className="absolute top-0 left-0 w-full h-full pointer-events-none md:w-3/5 xl:w-auto"> {/*pointer-events-none means that it is not clickable */}
               ...
               <Generating className="absolute left-4 right-4 bottom-4 border-n-1/10 border lg:left-1/2 lg-right-auto lg:bottom-8 lg:-translate-x-1/2"/> {/*absolute give us the ability to position the item wherever we want*/}
            </div>
                    ...
                    <div className="py-12 px-4 xl:px-8">
                        ...
                        <ul className="flex items-center justify-between">
                            {brainwaveServicesIcons.map((item, index) => (
                                <li key={index} className="group rounded-2xl flex items-center justify-center cursor-pointer w-12 h-12 md:w-15 md:h-15 p-0.25 bg-n-6 hover:bg-conic-gradient transition-all duration-300">
                                  <div className="flex items-center justify-center w-full h-full bg-n-6 rounded-2xl">
